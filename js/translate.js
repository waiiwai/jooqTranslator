String.prototype.select = function(...columns){
    return this + ' select ' + columns.map(column => column.camel2Snake());
}

String.prototype.insertInto = function(table, ...columns){
    return this + ' insert into ' + table + '(' + columns.map(column => column.camel2Snake()) + ')';
}
...
String.prototype.update = function(table){
    return this + ' update ' + table.camel2Snake();
}
...
String.prototype.deleteFrom = function(table){
    return this + ' delete from ' + table.camel2Snake();
}
String.prototype.from = function(table){
    return this + ' from ' + table.camel2Snake();
}
String.prototype.join = function(table){
    return this + ' join ' + table.camel2Snake();
}
